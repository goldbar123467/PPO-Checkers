...
| E9 | T1–T8, including hand-computed signed GAE. | Passing tests with derivation fixtures. | PROVEN by focused tests: T1–T8 pass, including literal T3 math, three engine-derived T7 actor-frame paths, and T8 chronology. Consolidated replay remains part of Gate 6 status. |
