...
Greedy versus sampled labels describe action selection from the neural logits. They are not separate networks and do not correspond to Minimax depth. The website uses greedy selection only.
