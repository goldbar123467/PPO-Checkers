...
- [ ] Deploy the immutable publication commit and record its image/source/model manifest.
- [ ] Exercise an image rollback and roll forward, including model checksum and legal-move smoke tests.
